...
config: {
  ...
  try {
    const ShanInfo = {
      ...
      birthday: '23-11-𝟐𝟎𝟎7',
      age:'17',
      Status: ' তুমি মেয়ে হলে I love you প্রেম করবা আমার সাথে 😝🤭',
      hobby: 'Book Reading, Anime watching, Editing and Namaz 🙂',
      religion: '𝙄𝒔𝒍𝑨𝒎',
      height: '5"3',
      ...
      tiktok: 'আমি প্রতিবন্ধী না তাই টিকটক করি না কিন্তু মাঝে মাঝে বন্ধু বান্ধবি দের পোস্ট লাইক দেই 😋',
      youtube: 'নিজের কোন চ্যানেল নাই, ইউটিউব প্রিমিয়াম ব্যাবহার করি 🙂',
    };
